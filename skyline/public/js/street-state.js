 ...
 * Used by the BFF tests and the browser (UMD).
 * Accounting is independent of the visual queue.
 */
(function (root, factory) {
  const exported = factory();
  if (typeof module !== 'undefined' && module.exports) module.exports = exported;
  else root.StreetState = exported;
  ...
  function applyVerifiedPayout(slots, event) {
  ...
  return { EventDedupe, FirmSlots, sortByTotal, applyVerifiedPayout, streetTotals };
});
